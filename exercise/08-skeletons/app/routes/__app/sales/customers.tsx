...
export default function Customers() {
  ...
  const transitionState = useTransition().location?.state as any;
  const nextCustomer = transitionState?.customer;

  const showSpinner = useSpinDelay(!!nextCustomer);
